...
public class Test implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Income i1 = new Income(null, 50.0, LocalDate.parse("2023-06-20"), t1, c1, "Income 1");
        Income i2 = new Income(null, 70.0, LocalDate.parse("2023-06-20"), t1, c1, "Income 2");
        Income i3 = new Income(null, 90.0, LocalDate.parse("2023-02-21"), t1, c1, "Income 3");
        Income i4 = new Income(null, 20.0, LocalDate.parse("2023-02-24"), t1, c2, "Income 4");
        Income i5 = new Income(null, 10.0, LocalDate.parse("2023-03-17"), t1, c2, "Income 5");
        ...
        Outcome o1 = new Outcome(null, 750.0, LocalDate.parse("2023-06-21"), t1, c1, "Outcome 1");
        Outcome o2 = new Outcome(null, 600.0, LocalDate.parse("2023-03-24"), t1, c1, "Outcome 2");
        Outcome o3 = new Outcome(null, 500.0, LocalDate.parse("2023-04-24"), t1, c1, "Outcome 3");
        Outcome o4 = new Outcome(null, 800.0, LocalDate.parse("2023-06-24"), t1, c1, "Outcome 4");
        Outcome o5 = new Outcome(null, 900.0, LocalDate.parse("2023-02-24"), t1, c1, "Outcome 5");
